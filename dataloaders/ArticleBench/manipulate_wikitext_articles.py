...
from dataloaders.dataloader_original_articles import Wikitext_article
...
if __name__=="__main__":
    ...
    parser.add_argument('--file_path', type=str, default="data/WikiText/data/wikitext2_test.jsonl",
    ...
    parser.add_argument('--output_dir', type=str, default="data/Text_Localization/Wikitext")
    ...
    if "wikitext" in args.file_path:
        news_data = Wikitext_article(file_path=args.file_path, article_num=args.article_num)
    ...
    batch_id = 0
    all_samples = []
    for batch in tqdm(news_dataloader, desc="manipulate Wikitext articles"):
